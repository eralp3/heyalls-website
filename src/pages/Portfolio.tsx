    ...
    <div className="relative min-h-screen w-full bg-[#001a2c] text-white selection:bg-white/20">
      ...
      <main className="relative z-10 flex flex-col items-center justify-center text-center px-6 pt-24 pb-16">
        ...
        <h1
          ...
          style={displayFont}
        >
          Fikirden, <em className="not-italic text-white/60">küresel operasyona.</em>
        </h1>
      ...
      <section className="relative z-10 max-w-6xl mx-auto px-6 md:px-8 py-16 space-y-32">
        ...
        <div className="flex flex-col lg:flex-row gap-12 items-center group">
          <div className="w-full lg:w-1/2">
            <div className="liquid-glass w-full aspect-video rounded-[2rem] overflow-hidden relative flex items-center justify-center bg-gradient-to-br from-white/5 to-transparent shadow-inner border border-white/5 group-hover:border-white/10 transition-all duration-500">
              <span
      ...
      <section className="relative z-10 max-w-4xl mx-auto px-6 py-32 text-center">
        ...
        {/* SPA mimarisine uygun kesintisiz geçiş linki */}
        <Link
          to="/#intake"
